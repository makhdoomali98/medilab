...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/important.css">
    <!-- Google Font: Source Sans Pro -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="http://localhost/medilab/admin/view/admin_view/plugins/fontawesome-free/css/all.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="http://localhost/medilab/admin/view/admin_view/dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="http://localhost/medilab/admin/view/admin_view/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="http://localhost/medilab/admin/view/admin_view/dashboard.php" class="brand-link">
            <span class="brand-text font-weight-light">Testing System</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">MediLab</a>
                </div>
            </div>
